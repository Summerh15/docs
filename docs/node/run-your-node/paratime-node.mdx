...
Reading the rest of the [validator node setup instructions](validator-node/README.md) may also be useful.
...
[Oasis CLI tools]: ../../general/manage-tokens/advanced/oasis-cli-tools/delegate-tokens.md
[Oasis Node Stake Account Info]: ../../general/manage-tokens/advanced/oasis-cli-tools/get-account-info.md

### Register a New Entity or Update Your Entity Registration

If you don't have an entity yet, create a new one by following the [Creating Your Entity](validator-node/README.md#creating-your-entity) instructions.
...
If you will be running the ParaTime on a new Oasis Node, initialize a new node by following the [Initializing a Node](validator-node/README.md#initializing-a-node) instructions.
...
Then generate and submit the new/updated entity descriptor via the entity registration transaction by following the [Generating Entity Registration Transaction](validator-node/README.md#generating-entity-registration-transaction) instructions.
